...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
      ...
      $symbols = [
        ['BINANCE:BTC/BUSD', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/IDRT', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/RUB', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/ZAR', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/BKRW', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/UAH', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/GBP', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/NGN', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/USDC', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/DAI', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/USDT', mt_rand(50, 85), 0, 0],
        ['BINANCE:BTC/AUD', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/PAX', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/TUSD', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/BIDR', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/EUR', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/TRY', mt_rand(50, 85), 23, 1],
        ['BINANCE:BTC/USDTPERP', mt_rand(50, 85), 23, 1],
        ['BITFINEX:BTC/XCH', mt_rand(50, 85), 23, 1],
        ['BITFINEX:BTC/UST', mt_rand(50, 85), 23, 1],
        ['BITFINEX:BTC/EUR', mt_rand(50, 85), 23, 1],
        ['BITFINEX:BTC/JPY', mt_rand(50, 85), 23, 1],
        ['BITFINEX:BTC/USD', mt_rand(50, 85), 23, 1],
        ['BITFINEX:BTC/GBP', mt_rand(50, 85), 23, 1],
        ['BITFINEX:BTC/CNHT', mt_rand(50, 85), 23, 1],
        ['BITFLYER:BTC/JPY3M', mt_rand(50, 85), 23, 1],
        ['BITFLYER:BTC/JPY', mt_rand(50, 85), 23, 1],
        ['BITHUMB:BTC/KRW', mt_rand(50, 85), 23, 1],
        ['BITSO:BTC/MXN', mt_rand(50, 85), 23, 1],
        ['BITSTAMP:BTC/EUR', mt_rand(50, 85), 23, 1],
        ['BITSTAMP:BTC/USD', mt_rand(50, 85), 23, 1],
        ['BITSTAMP:BTC/GBP', mt_rand(50, 85), 23, 1],
        ['BITSTAMP:BTC/PAX', mt_rand(50, 85), 23, 1],
        ['BINANE:ETH/USDT', mt_rand(50, 85), 23, 1],
        ['BITTREX:BTC/USD', mt_rand(50, 85), 23, 1],
        ['BITTREX:BTC/EUR', mt_rand(50, 85), 23, 1],
