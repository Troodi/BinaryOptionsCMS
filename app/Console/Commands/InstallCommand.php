...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
      ...
      $symbols = [
        ...
        ['FX:EUR/USD', mt_rand(50, 85), 23, 0],
        ['FX:GBP/USD', mt_rand(50, 85), 23, 0],
        ['FX:GBP/JPY', mt_rand(50, 85), 23, 0],
        ['FX:USD/JPY', mt_rand(50, 85), 23, 0],
        ['FX:AUD/USD', mt_rand(50, 85), 23, 0],
        ['FX:USD/CAD', mt_rand(50, 85), 23, 0],
        ['FX:EUR/JPY', mt_rand(50, 85), 23, 0],
        ['FX:GBP/AUD', mt_rand(50, 85), 23, 0],
        ['FX:EUR/GBP', mt_rand(50, 85), 23, 0],
        ['FX:NZD/USD', mt_rand(50, 85), 23, 0],
        ['FX:USD/CHF', mt_rand(50, 85), 23, 0],
        ['FX:USD/TRY', mt_rand(50, 85), 23, 0],
        ['FX:EUR/AUD', mt_rand(50, 85), 23, 0],
        ['FX:AUD/JPY', mt_rand(50, 85), 23, 0],
        ['FX:EUR/NZD', mt_rand(50, 85), 23, 0],
        ['FX:EUR/CAD', mt_rand(50, 85), 23, 0],
        ['FX:GBP/CAD', mt_rand(50, 85), 23, 0],
        ['FX:CAD/JPY', mt_rand(50, 85), 23, 0],
        ['FX:AUD/CAD', mt_rand(50, 85), 23, 0],
        ['FX:GBP/NZD', mt_rand(50, 85), 23, 0],
        ['FX:GBP/CHF', mt_rand(50, 85), 23, 0],
        ['FX:AUD/NZD', mt_rand(50, 85), 23, 0],
        ['FX:CHF/JPY', mt_rand(50, 85), 23, 0],
        ['FX:NZD/JPY', mt_rand(50, 85), 23, 0],
        ['FX:EUR/CHF', mt_rand(50, 85), 23, 0],
        ['FX:NZD/CAD', mt_rand(50, 85), 23, 0],
        ['FX:AUD/CHF', mt_rand(50, 85), 23, 0],
        ['FX:CAD/CHF', mt_rand(50, 85), 23, 0],
        ['FX:NZD/CHF', mt_rand(50, 85), 23, 0],
        ['FX:USD/ZAR', mt_rand(50, 85), 23, 0],
        ['FX:USD/MXN', mt_rand(50, 85), 23, 0],
        ['FX:EUR/TRY', mt_rand(50, 85), 23, 0],
        ['FX:USD/CNH', mt_rand(50, 85), 23, 0],
        ['FX:USD/SEK', mt_rand(50, 85), 23, 0],
        ['FX:USD/NOK', mt_rand(50, 85), 23, 0],
        ['FX:EUR/NOK', mt_rand(50, 85), 23, 0],
        ['FX:EUR/SEK', mt_rand(50, 85), 23, 0],
        ['FX:USD/HKD', mt_rand(50, 85), 23, 0],
        ['FX:ZAR/JPY', mt_rand(50, 85), 23, 0],
        ['FX:TRY/JPY', mt_rand(50, 85), 23, 0],
      ];
