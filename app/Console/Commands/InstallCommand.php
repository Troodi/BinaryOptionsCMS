...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
      ...
      $symbols = [
        ...
        ['FXCM:EUR/USD', mt_rand(50, 85)],
        ['FXCM:GBP/USD', mt_rand(50, 85)],
        ['FXCM:USD/CHF', mt_rand(50, 85)],
        ['FXCM:EUR/GBP', mt_rand(50, 85)],
        ['FXCM:EUR/JPY', mt_rand(50, 85)],
        ['FXCM:USD/SEK', mt_rand(50, 85)],
        ['FXCM:USD/RUB', mt_rand(50, 85)],
        ['FXCM:USD/NOK', mt_rand(50, 85)],
        ['FXCM:EUR/CHF', mt_rand(50, 85)],
        ['FXCM:EUR/SEK', mt_rand(50, 85)],
        ['FXCM:EUR/NOK', mt_rand(50, 85)],
        ['FXCM:EUR/AUD', mt_rand(50, 85)],
        ['FXCM:CAD/CHF', mt_rand(50, 85)],
        ['FXCM:CHF/RUB', mt_rand(50, 85)],
      ];
