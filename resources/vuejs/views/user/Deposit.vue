                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    ...
                                                    <div class="row mb-1 mr-0 ml-0">
                                                        <div class="col-md-3 pl-0" style="padding-right: 3px;">
                                                            <button type="button" class="btn w-100 btn-sm btn-outline-dark">$ 150</button>
                                                        </div>
                                                        <div class="col-md-3 pl-0" style="padding-right: 1.5px;">
                                                            <button type="button" class="btn w-100 btn-sm btn-outline-dark">$ 200</button>
                                                        </div>
                                                        <div class="col-md-3 pr-0" style="padding-left: 1.5px;">
                                                            <button type="button" class="btn w-100 btn-sm btn-outline-dark">$ 300</button>
                                                        </div>
                                                        <div class="col-md-3 pr-0" style="padding-left: 3px;">
                                                            <button type="button" class="btn w-100 btn-sm btn-outline-dark">$ 500</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row" v-for="current in bonus" style="padding-bottom: 5px;">
                                                <div class="col-md-12">
                                                    <div class="btn btn-light-secondary w-100">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <fieldset>
                                                                    <div class="radio radio-primary radio-glow" style="padding-top: 5px;">
                                                                        <input type="radio" :id="'radio'+current.amount" name="radioGlow" checked="">
...
<script>
    export default {
        ...
        data: function () {
            return {
                bonus: [
                    { amount: '10 000', percent: '100' },
                    { amount: '5 000', percent: '90' },
                    { amount: '3 000', percent: '80' },
                    { amount: '1 000', percent: '70' },
                    { amount: '500', percent: '65' },
                    { amount: '250', percent: '60' },
                    { amount: '100', percent: '55' },
                    { amount: '50', percent: '50' },
