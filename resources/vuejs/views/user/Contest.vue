            ...
            <div class="card faq-bg bg-transparent box-shadow-0 p-1 p-md-5">
              <div class="card-content">
                <div class="card-body p-0">
                  <h1 class="faq-title text-center mb-1">Турниры для трейдеров</h1>
                  ...
                  <p class="card-text text-center mt-1 font-medium-1 text-muted">
                    ...
                    Описание Описание Описание Описание Описание Описание Описание Описание<br>
                    Описание Описание Описание Описание Описание Описание Описание<br>
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                  <div class="swiper-centered-slides swiper-container p-1">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide rounded swiper-shadow" id="ended" style="width: 30% !important;min-width: 200px;"> <i
                        ...
                        <div class="cent-text1">Завершенные конкурсы</div>
                      </div>
                    </div>
                    <!-- Add Arrows -->
                  ...
                  <div class="wrapper-content" data-faq="planned">
                    <div class="text-center p-md-4 p-sm-1 py-1 p-0">
                      <h1 class="faq-title">Запланированные конкурсы</h1>
                  ...
                  <div class="main-wrapper-content">
                    <div class="wrapper-content" data-faq="active">
                      <div class="text-center p-md-4 p-sm-1 py-1 p-0">
                        <h1 class="faq-title">Список активных конкурсов</h1>
                        <p>Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание
                          Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание
                          Описание Описание Описание Описание Описание Описание Описание </p>
                      </div>
                    ...
                    <div class="wrapper-content" data-faq="ended">
                      <div class="text-center p-md-4 p-sm-1 py-1 p-0">
                        <h1 class="faq-title">Завершенные конкурсы</h1>
                        <p>Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание
                          Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание
                          Описание Описание Описание Описание Описание Описание Описание </p>
                      </div>
...
export default {
  ...
  mounted() {
    let self = this;
    axios.post('/data/getAllContests')
