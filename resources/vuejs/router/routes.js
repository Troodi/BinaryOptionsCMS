...
export const routes = [
    ...
    { path: '/tournaments', name: i18n.t('tournament_list'), component: Contest, meta: { icon: 'bulb' } },
    { path: '/tournament/:tournament_id', name: i18n.t('tournament_info'), component: ContestInfo, meta: { icon: 'bulb', hide: true } },
