...
class CreateSymbolDemoStatisticsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('symbol_demo_statistics', function (Blueprint $table) {
          $table->id();
    ...
    {
        Schema::dropIfExists('symbol_demo_statistics');
    }
}
