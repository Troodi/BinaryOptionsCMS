...
class CreateContestLatestOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contest_latest_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('contest_latest_orders');
    }
}
