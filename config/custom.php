...
return [
    'custom' => [
        ...
        'theme' => 'dark',  //light(default),dark,semi-dark (note: Horizontal-menu not applicable for semi-dark)
        ...
        'templateTitle' => 'GetOption', //template Title can be changed, default(Frest)
        'isCardShadow' => false, // Option: true(default) and false ( remove card shadow)
